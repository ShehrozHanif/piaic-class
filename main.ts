...
let fruit:string[] = ["apple","lichi","kiwi","mango"]
...
let fruits:string[] =["Apple","mango","banana","apricot"]
...
let vegetables:string[] = ["onion","potato","tomato","lady finger"]
...
let friends:string[] = ["Hasnain","Akash","Nabeel","Akbar"]
...
let profile:[string,number,string]=["Shehroz Hanif",25,"Ai Engineer"] // in this variable we allow only type like [string,string,number] if we add
...
let froot:string[] =["mango","banana","kinno","lichi"]
...
let students:{name:string,age:number,qualification:string}[]=[
    {
        name:"Shehroz",
        age:25,
